...
const HeroSection = () => {
  ...
  return <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden py-8">
    ...
    <div className={`container mx-auto px-6 text-center relative z-10 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
      ...
      </div>        {/* Logo Voxy Mix com Background Especial */}
      <div className={`relative mx-auto mb-10 transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
        <div className="w-32 h-32 mx-auto relative rounded-full flex items-center justify-center overflow-hidden"
          style={{
            background: `
    ...
    <style>{`
        ...
        @keyframes logoGlow {
          ...
          100% { 
            box-shadow: 0 0 30px rgba(0, 162, 255, 0.8), 0 0 50px rgba(0, 255, 200, 0.3);
          }
        }
